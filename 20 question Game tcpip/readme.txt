...
compilation command:                         make tcpip



Run command:                                 For the oracle run: ./tcpip - port number   ,   For the guesser run: ./tcpip IP - address - port number



Purpose:                                     Trying to get us to know how networking works using TCPIP network protocols by making a 2 player game that
                                             one can play over a network by sharing their IP addresses and port number.     




Result:                                       Connects to the server using and IP address and a specified port using command line arguement. When connected,
